...
export default function Q9_negativeFeel() {
    const router = useRouter();
    const { setUserData } = useMainStore();

    const handleStartClick = async (e) => {
        await setUserData({ q9_negativeFeel: e });
        router.push('/lifepage/q10_dailyActivity');
    }
            ...
            <div className="max-w-2xl w-full text-center space-y-5">
                ...
                <div className="space-y-2">
                    <h1 className="text-2xl font-bold text-green-800">
                        คุณมีความรู้สึกไม่ดี เช่น เหงา เศร้า หดหู่ กังวล บ่อยแค่ไหน
                    </h1>
                </div>
