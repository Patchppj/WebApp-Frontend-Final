...
export default function Q11_onMedication() {
    const router = useRouter();
    const { setUserData } = useMainStore();

    const handleStartClick = async (e) => {
        await setUserData({ q11_onMedication: e });
        router.push('/lifepage/q12_working');
    }
            ...
            <div className="max-w-2xl w-full text-center space-y-5">
                ...
                <div className="space-y-2">
                    <h1 className="text-2xl font-bold text-green-800">
                        คุณจำเป็นต้องไปรับการรักษาพยาบาลมากน้อยเพียงใด เพื่อที่จะทำงานหรือมีชีวิตอยู่ไปได้ในแต่ละวัน
                    </h1>
                </div>
