...
export default function Q25_sex() {
    const router = useRouter();
    const { setUserData } = useMainStore();

    const handleStartClick = async (e) => {
        await setUserData({ q25_sex: e });
        router.push('/lifepage/q26_level');
    }
        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-white">
            <div className="max-w-2xl w-full text-center space-y-5">
                ...
                <div className="space-y-2">
                    ...
                    คุณพอใจในชีวิตทางเพศของคุณแค่ไหน (ชีวิตทางเพศ หมายถึง เมื่อเกิดความรู้สึกทางเพศแล้วคุณสามารถจัดการตัวเองได้)
                    </h1>
                </div>
