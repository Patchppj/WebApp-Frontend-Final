...
export default function Q10_dailyActivity() {
    const router = useRouter();
    const { setUserData } = useMainStore();

    const handleStartClick = async (e) => {
        await setUserData({ q10_dailyActivity: e });
        router.push('/lifepage/q11_onMedication');
    }
            ...
            <div className="max-w-2xl w-full text-center space-y-5">
                ...
                <div className="space-y-2">
                    <h1 className="text-2xl font-bold text-green-800">
                        คุณรู้สึกพอใจมากน้อยแค่ไหนที่สามารถทำอะไรผ่านไปได้ในแต่ละวัน
                    </h1>
                </div>
