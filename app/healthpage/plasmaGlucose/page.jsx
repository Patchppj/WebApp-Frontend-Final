...
export default function PlasmaGlucose() {
    const router = useRouter();
    const { setUserData, userData } = useMainStore();

    const handleStartClick = (e) => {
        setUserData({ plasmaGlucose: e });
        router.push('/healthpage/plasmaInsulin');
    }
            ...
            <div className="max-w-2xl w-full text-center space-y-5">
                ...
                <div className="space-y-2">
                    <h1 className="text-2xl font-bold text-green-800">
                        คุณมีค่าผลตรวจสุขภาพระดับน้ำตาลในเลือด (Fasting Blood Sugar) ที่ระดับไหน
                    </h1>
                </div>
